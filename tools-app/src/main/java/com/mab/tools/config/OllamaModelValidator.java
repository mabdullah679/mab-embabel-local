...
public class OllamaModelValidator {
    ...
    ApplicationRunner validateOllamaModels(RestTemplate restTemplate,
        ...
        return args -> {
            ...
            validateDeclaredModel("embedding", embeddingModel, available);
            log.info("Validated Ollama models from deployment config. generation={} fallback={} embedding={}", generationModel, fallbackModel, embeddingModel);
        };
    }
